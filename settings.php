...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configtext('auth_imisbridge/imis_home_url',
        get_string('imis_home_url_label', 'auth_imisbridge'),
        get_string('imis_home_url_desc', 'auth_imisbridge'), '', PARAM_URL));
